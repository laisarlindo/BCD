...
FROM tb_cliente cl
JOIN tb_cor c ON tb_cor.id_cor = tb_cliente.COR_id_cor_favorita
LEFT JOIN tb_pedido_roupa pd ON tb_pedido_roupa.CLIENTE_id_cliente = tb_cliente.id_cliente
...
select tb_cliente.primeiro_nome, sobrenome as nome_completo, 
