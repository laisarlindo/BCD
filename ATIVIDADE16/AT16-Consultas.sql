...
SELECT  COUNT(CPF) AS CPF FROM funcionarios
WHERE Salario > 4000;
...
SELECT MAX(Salario) AS salario_minimo FROM funcionarios
...
SELECT COUNT(SegundoNome AND UltimoNome) AS funcionario_nome FROM funcionarios
WHERE SegundoNome OR UltimoNome OR Salario > 3500;

-- 13. Selecione o salário-mínimo entre os funcionários que trabalham como Designer E têm CPF cadastrado.
SELECT MIN(Salario) AS salario_medio FROM funcionarios
...
SELECT COUNT(Salario) AS funcionari_salario FROM funcionarios
