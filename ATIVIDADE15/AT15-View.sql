...
SELECT nome_produto, categoria, estoque, (preco_venda - preco_compra) AS lucro_bruto
FROM tb_produto
WHERE estoque > 50;
...
SELECT nome_cliente, telefone_cliente, cidade, estado,estoque, SUM(preco_venda-preco_compra) AS soma_lucro_bruto
FROM tb_cliente JOIN tb_produto
WHERE estoque < 50 AND tb_cliente.estado = "SP" OR "RJ" OR "MG" OR "ES"
